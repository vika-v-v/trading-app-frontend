...
Preview Login:
<a href="https://www.youtube.com/watch?v=2qALI9QUW5A?autoplay=1" target="_blank" style="max-width: 80vw"><img src="/wertpapieranlagen/src/assets/preview/demo_login_videopreview.png" alt="Demo login" style="max-width:80%;"></a>

Preview Register:
<a href="https://www.youtube.com/watch?v=ghZr5NSFoVE?autoplay=1" target="_blank" style="max-width: 80vw"><img src="/wertpapieranlagen/src/assets/preview/demo_register_videopreview.png" alt="Demo login" style="max-width:80%;"></a>
